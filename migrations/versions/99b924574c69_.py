...
Revision ID: 99b924574c69
Revises: 
Create Date: 2019-12-01 00:24:30.877699
...
def upgrade():
    ...
    op.create_index(op.f('ix_note_already_reminded'), 'note', ['already_reminded'], unique=False)
    ...
    op.create_index(op.f('ix_note_reminder_date'), 'note', ['reminder_date'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_note_reminder_date'), table_name='note')
    ...
    op.drop_index(op.f('ix_note_already_reminded'), table_name='note')
    op.drop_table('note')

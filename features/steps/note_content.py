...
def step_impl(context):
    with context.context:
        assert(context.browser.is_text_present('This is the title') and context.browser.is_text_present('This is the note') and context.browser.is_text_present('tag, tag2, tag3'))
